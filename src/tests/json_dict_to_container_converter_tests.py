...
from json_dict_to_container_converter import JsonDictToContainerConverter

class JsonDictToContainerConverterUnitTests(unittest.TestCase):
    """Unit tests for the JsonDictToContainerConverter class."""

    def setUp(self):
        self._test_json_dict_to_container_converter = JsonDictToContainerConverter()


    def test_convert_to_iterable_input_list_parameter_not_List(self):
        with self.assertRaises(ValueError) as result:
            list(self._test_json_dict_to_container_converter.convert_to_iterable(set(), StringUniqueStringifier()))
    ...
    def test_convert_to_iterable_input_list_element_not_string(self):
        with self.assertRaises(ValueError) as result:
            list(self._test_json_dict_to_container_converter.convert_to_iterable([ "ABC", 1, "DEF"  ], StringUniqueStringifier()))
    ...
    def test_convert_to_iterable(self):
        ...
        result: List[str] = list(self._test_json_dict_to_container_converter.convert_to_iterable(test_input_list, test_stringifier))
    ...
    def test_convert_to_iterable_of_tuples_input_dicts_parameter_not_List(self):
        with self.assertRaises(ValueError) as result:
            list(self._test_json_dict_to_container_converter.convert_to_iterable_of_tuples(
                set(), 
    ...
    def test_convert_to_iterable_of_tuples(self):
        ...
        result: List[Tuple[str, str]] = list(self._test_json_dict_to_container_converter.convert_to_iterable_of_tuples(
                test_input_dict, 
                "ApplicationComponent", 
                "AccessLevel",
                test_stringifier_1, 
    ...
    def test_convert_to_set(self):
        ...
        result: Set[str] = set(self._test_json_dict_to_container_converter.convert_to_iterable(test_input_list, test_stringifier))
    ...
    def test_convert_to_set_of_tuples(self):
        test_input_dict = [ 
            { "ApplicationComponent": "OrderScreen", "AccessLevel": "Modify" }, 
            { "ApplicationComponent": "SummaryScreen", "AccessLevel": "View" },
            { "ApplicationComponent": "SetupScreen", "AccessLevel": "Create" }
        ...
        result: Set[Tuple[str, str]] = set(self._test_json_dict_to_container_converter.convert_to_iterable_of_tuples(
                test_input_dict, 
                "ApplicationComponent", 
                "AccessLevel",
                test_stringifier_1, 
        ...
        self.assertEqual(3, len(result))
        self.assertTrue( ("OrderScreen", "Modify") in result)
        self.assertTrue( ("SummaryScreen", "View") in result)
        self.assertTrue( ("SetupScreen", "Create") in result)
        self.assertEqual(0, test_stringifier_1._to_string_count)
        self.assertEqual(3, test_stringifier_1._from_string_count)
        self.assertEqual(0, test_stringifier_2._to_string_count)
        self.assertEqual(3, test_stringifier_2._from_string_count)
